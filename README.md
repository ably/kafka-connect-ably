...
It is possible to use the connector as a plugin on Confluent Cloud, referred to as "Custom Connectors". These steps assume that you have created a Confluent Cloud account and configured your cluster.
