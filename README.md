...
| -------- | ----------- | ---- | ------- |
| channel | The name of the [Ably channel](https://ably.com/documentation/realtime/channels) to publish to. Also see: [Dynamic channel configuration](#-Dynamic-Channel-Configuration) | *String* ||
